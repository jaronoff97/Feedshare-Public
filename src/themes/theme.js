...
export default {
    ...
    // Button
    btnFontFamily: (Platform.OS === 'ios' ) ? 'AvenirLTStd-Book' : 'Roboto_medium',
    ...
    get btnTextSize () {
        return (Platform.OS==='ios') ? this.fontSizeBase*1 :
        this.fontSizeBase-2;
    },
    ...
    tabBarActiveTextColor: '#e63039',
    tabActiveBgColor: 'transparent',
    tabBarBigColor: '#e63039',
    tabBarBigTextColor: '#fff',
    ...
    // Icon
    iconFamily: 'Ionicons',
    iconFontSize: (Platform.OS === 'ios' ) ? 28 : 28,
    iconMargin: 4,
